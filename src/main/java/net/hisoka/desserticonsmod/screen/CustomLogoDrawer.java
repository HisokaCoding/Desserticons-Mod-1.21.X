...
public class CustomLogoDrawer {
    public static final Identifier LOGO_TEXTURE = Identifier.of("desserticonsmod","textures/gui/title/minecraft.png");
    public static final Identifier MINCERAFT_TEXTURE = Identifier.of("desserticonsmod","textures/gui/title/minceraft.png");
    ...
    public CustomLogoDrawer(boolean ignoreAlpha) {
