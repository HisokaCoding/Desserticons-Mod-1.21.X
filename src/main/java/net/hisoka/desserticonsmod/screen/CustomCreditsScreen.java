package net.hisoka.desserticonsmod.screen;
...
public class CustomCreditsScreen extends Screen {
    ...
    private static final Identifier END_POEM_TEXT_LOCATION = Identifier.of("desserticonsmod","texts/end.txt");
    private static final Identifier CREDITS_TEXT_LOCATION = Identifier.of("desserticonsmod","texts/credits.json");
    private static final Identifier POST_CREDITS_TEXT_LOCATION = Identifier.of("desserticonsmod","texts/postcredits.txt");
    ...
    private final CustomLogoDrawer logoDrawer = new CustomLogoDrawer(false);

    public CustomCreditsScreen(boolean endCredits, Runnable finishAction) {
    ...
    protected CustomCreditsScreen(Text title, boolean endCredits, Runnable finishAction, float baseSpeed) {
        super(title);
        this.endCredits = endCredits;
        this.finishAction = finishAction;
    ...
    private void load(Identifier fileLocation, CustomCreditsScreen.CreditsReader reader) {
        try {
