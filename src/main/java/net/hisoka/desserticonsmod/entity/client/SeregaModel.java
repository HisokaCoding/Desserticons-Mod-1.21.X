...
public class SeregaModel <T extends SeregaEntity> extends SinglePartEntityModel<T> {

    public static final EntityModelLayer SEREGA = new EntityModelLayer(Identifier.of(DesserticonsMod.MOD_ID, "serega"), "main");
    ...
    @Override
    public void setAngles(SeregaEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
