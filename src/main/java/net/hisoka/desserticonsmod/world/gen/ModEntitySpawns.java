...
public class ModEntitySpawns {
    public static void addSpawn() {
        ...
        BiomeModifications.addSpawn(BiomeSelectors.includeByKey(BiomeKeys.BADLANDS, BiomeKeys.DESERT, BiomeKeys.SAVANNA), SpawnGroup.CREATURE, ModEntities.ARKAWA, 30, 1, 1);
        BiomeModifications.addSpawn(BiomeSelectors.includeByKey(BiomeKeys.JUNGLE, BiomeKeys.BAMBOO_JUNGLE, BiomeKeys.SPARSE_JUNGLE), SpawnGroup.CREATURE, ModEntities.JORA, 30, 1, 1);
    }
}
