...
public class MaximAnimations {

    public static final Animation MAXIM_WALK_ANIMATION = Animation.Builder.create(1f).looping()
    ...
    public static final Animation MAXIM_IDLE_ANIMATION = Animation.Builder.create(0.5f).looping()
            .addBoneAnimation("leg",
                    new Transformation(Transformation.Targets.ROTATE,
